    ...
    <footer className="footer">
      <div className="container">
          ...
          <div className="footer__col">
            ...
            <ul className="footer__links footer__contact-list">
              <li>
                ...
                <a href="tel:07555653736">07555 653736</a>
              </li>
              <li>
        ...
        <div className="footer__bottom">
          <p>&copy; {new Date().getFullYear()} LV Exterior Cleaning. All rights reserved. Made &amp; Designed By <a href="https://www.kavotech.uk" target="_blank" rel="noopener noreferrer" className="footer__credit">Kavo Technologies</a></p>
        </div>
      </div>
    </footer>
  )
